...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="qrgen.php">
                    ...
                    <div class="row">
                        <div class="container">
                                                    ...
                                                    <div class="p-5">
                                                        <form class="user"  method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">Banner
                                                                    Title</label>
                                                                <input type="text" class="form-control form-control-user" id="name" name="name" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="desc" class="form-label">Banner
                                                                    Description</label>
                                                                <textarea class="form-control form-control-user" id="description" name="description" rows="2"></textarea>
                                                            </div><br>
                                                            <div class="form-group">
                                                                <label for="image">Banner : </label>
                                                                <input type="file" name="image" id="image" name="image" required>
                                                            </div><br>
                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Display Details</h4>

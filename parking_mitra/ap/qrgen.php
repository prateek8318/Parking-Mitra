                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = $conn->query("SELECT * FROM ordr ORDER BY id DESC");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="nav-item dropdown">
                                                    <button class="nav-link btn btn-secondary dropdown-toggle" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Ordered</button>

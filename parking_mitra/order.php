            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Order QR</h1>
                    </div>
                                                    ...
                                                    <div class="p-5">
                                                        <form class="user" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control form-control-user" id="name" name="name" value="" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">Mobile </label>
                                                                <input type="number" class="form-control form-control-user" id="mobile" name="mobile" value="" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">E-Mail </label>
                                                                <input type="text" class="form-control form-control-user" id="email" name="email" value="" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="desc" class="form-label">Address</label>
                                                                <textarea class="form-control form-control-user" id="address" name="address" rows="2"></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">City</label>
                                                                <input type="text" class="form-control form-control-user" id="city" name="city" value="" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">State</label>
                                                                <input type="text" class="form-control form-control-user" id="state" name="state" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">Pincode</label>
                                                                <input type="number" class="form-control form-control-user" id="pincode" name="pincode" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title" class="form-label">Quantity</label>
                                                                <input type="number" class="form-control form-control-user" id="quantity" name="quantity" aria-describedby="emailHelp">
                                                            </div><br>
                                                            <button type="submit" name="insert" class="btn btn-primary">Order</button>
                                                            <?php
                                                            $order->insert();
                                                            $qr->qrgen();
                                                            ?>
